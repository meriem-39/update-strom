            ...
            <header>
                <div class="heder">
                    ...
                    <div > 
                     ...
                     <input class="log-in" type="button" value="logout" />
                    </div>
                </div>
      ...
      while($row = mysqli_fetch_array($result)){
           ...
           <main>
            <div class='prodoie';>;
                ...
                <hr>
                <p class='cach'>" . $row['price'] . "</p>
                 <div>
                    <button class='bay'>add to card<i class='bx bxs-cart'></i></button>
        ...
        ?>
          ...
          <!-- <div class="prodoie">
                <img class="img" src="strom.png" alt="pro">
